                ...
                <div class="col-md-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">List Forum</h2>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12" style="overflow:auto;">
                                    <table class="table table-hover" id="tabelForum">
                                        <thead id="tc_thead" >
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{route('forum.destroy',$forum->slug)}}"
                                                        ...
                                                        {{method_field('DELETE')}}
                                                        <button type="submit"
                                                            class="btn btn-danger btn-sm btn-block" onclick="return confirm('Yakin mau dihapus?')">DELETE</button>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <p>
                                        Halaman ini merupakan halaman forum. Pergunakan fungsi ini sebijak mungkin untuk 
                                        berbagi ilmu pengetahuan kepada sesama.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="{{route('tag.show', $tag->slug)}}"
                                        class="label label-info">{{$tag->name}}
                                        ({{$tag->forum->count()}}<small> thread</small>)</a>
                                    @endforeach
