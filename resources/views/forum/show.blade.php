                ...
                <div class="col-md-8">
                    <div class="panel">
                        <div class="panel-heading">
                            <h2 class="panel-title">Detail Forum</h2>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="forum_info">
                                                <a href="#"
                                                    class="label label-success">{{$forums->user->name}}</a>|<small>
                                                    {{$forums->created_at->diffForHumans()}} </small>|
                                                ...
                                                @else
                                                <div class="label label-success"><i class="fa fa-image"></i></div>
                                                @endif
                                                <h3>{{$forums->title}}</h3>
                                            </div>
                                            ...
                                            <div class="forum_description">
                                                ...
                                                <div class="tc_if_empty">
                                                    <a data-toggle="collapse" data-target="#open_modal"><i
                                                            class="fa fa-image" id="zoom_image"></i></a>
                ...
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-footer">
                            <div class="reply_comment pull-right">
                                <a data-toggle="collapse" href="#{{$comment->id}}-collapse1reply"><i
                                        class="fa fa-comment-o "></i> Reply</a>
                            </div>
                            <div class="info_comment">
                                <a data-toggle="collapse" href="#{{$comment->id}}-collapse1info"><i
                                        class="fa fa-info-circle"></i> Info</a>
                            </div>
                        </div>

                        <div id="{{$comment->id}}-collapse1info" class="panel-collapse collapse">
                            <div class="panel-body">*Klik 'Reply' untuk melihat atau
                                membuat komentar balasan.</div>
                        </div>
                        <div id="{{$comment->id}}-collapse1reply" class="panel-collapse collapse">
                            <div class="panel-body">
                                <!-- forelse reply-->
                                @forelse($comment->comments as $reply)
                                <div class="panel">
                                    <div class="panel-header" style="background-color: #5cb85c; ">
                                        <i class="fa fa-clock-o" style="color: #eee"></i> <small
                                            style="color: #eee">{{$reply->created_at->diffForHumans()}}
                                        </small>
                                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="modal_img">
                <img src="{{asset('images/'.$forums->image)}}" width="500px" text-align="center" alt="">
            </div>
        </div>
    </div>
</div>
