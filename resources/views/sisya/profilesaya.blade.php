							...
							<div class="profile-left">
								...
								<div class="profile-header">
									...
									<div class="profile-main">
										<img width="250" height="250" src="{{$sisya->getAvatar()}}" class="img-circle" alt="Avatar">
								...
								<div class="profile-detail">
									...
									<div class="text-center"><a href="/sisya/{{auth()->user()->sisya->id}}/edit" class="btn btn-warning">Edit Profile</a></div>
								</div>
								<!-- END PROFILE DETAIL -->
							</div>
							<!-- END LEFT COLUMN -->
