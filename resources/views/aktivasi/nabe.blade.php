                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            ...
                            <p class="text-muted font-13 m-b-30">
                                Data dibawah merupakan tampilan data Nabe yang terdaftar pada Pasraman Pinandita Vidya
                            ...
                            <table class="table table-hover" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$nabe->alamat}}</td>
                                        <td>
                                            <a href="/nabe/{{$nabe->id}}/edit" type="button" class="btn btn-primary btn-xs"><i
